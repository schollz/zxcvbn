MxSamplesZInstrument {
	...
	*new {
		arg serverName,folderToSamples,numberMaxSamples,argBusCompressible,argBusNotCompressible,argBusCompressing,argBusReverb;
		^super.new.init(serverName,folderToSamples,numberMaxSamples,argBusCompressible,argBusNotCompressible,argBusCompressing,argBusReverb);
	}
	...
	init {
		...
		SynthDef("playx2",{
			...
			sendCompressible=0,sendCompressing=0,sendReverb=0,
			startPos=0;
			var snd,snd2;
	...
	noteOn {
		arg note,velocity,amp,pan,attack,release,duration,sendCompressible,sendCompressing,sendReverb;
			...
			if (buf.at(file2).isNil,{
				...
				if (fileLoaded.notNil,{
					...
					this.doPlay(noteOriginal,fileLoaded,fileLoaded,buf1mix,rateLoaded,
						amp,pan,attack,release,duration,sendCompressible,sendCompressing,sendReverb);
				});
	...
	doPlay {
		arg note,file1,file2,buf1mix,rate,amp,pan,attack,release,duration,sendCompressible,sendCompressing,sendReverb;
