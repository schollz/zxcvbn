...
Compilation options: -a supercollider.cpp -lang cpp -i -es 1 -mcd 16 -single -ftz 0
------------------------------------------------------------ */
...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a supercollider.cpp -lang cpp -i -es 1 -mcd 16 -single -ftz 0");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		iConst14 = std::min<int>(65536, std::max<int>(0, int(0.0892443135f * fConst0) + -1));
		iConst15 = std::min<int>(65536, std::max<int>(0, int(0.00491448538f * fConst0) + -1));
		iConst16 = std::min<int>(65536, std::max<int>(0, int(0.00348745007f * fConst0) + -1));
		iConst17 = std::min<int>(65536, std::max<int>(0, int(0.0123527432f * fConst0) + -1));
		iConst18 = std::min<int>(65536, std::max<int>(0, int(0.00958670769f * fConst0) + -1));
		iConst19 = std::min<int>(65536, std::max<int>(0, int(0.124995798f * fConst0))) + 1;
		iConst20 = std::min<int>(65536, std::max<int>(0, int(0.149625346f * fConst0)));
		iConst21 = std::min<int>(65536, std::max<int>(0, int(0.0604818389f * fConst0) + -1));
		iConst22 = std::min<int>(65536, std::max<int>(0, int(0.00893787201f * fConst0)));
		...
		iConst25 = std::min<int>(65536, std::max<int>(0, int(0.0642787516f * fConst0)));
		iConst26 = std::min<int>(65536, std::max<int>(0, int(0.0668660328f * fConst0)));
		iConst27 = std::min<int>(65536, std::max<int>(0, int(0.0062833908f * fConst0)));
		iConst28 = std::min<int>(65536, std::max<int>(0, int(0.0358186886f * fConst0)));
		iConst29 = std::min<int>(65536, std::max<int>(0, int(0.0118611604f * fConst0)));
		iConst30 = std::min<int>(65536, std::max<int>(0, int(0.121870905f * fConst0)));
		iConst31 = std::min<int>(65536, std::max<int>(0, int(0.0898155272f * fConst0)));
		...
		iConst34 = std::min<int>(65536, std::max<int>(0, int(0.0112563418f * fConst0)));
		iConst35 = std::min<int>(65536, std::max<int>(0, int(0.00406572362f * fConst0)));
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Predelay", &fHslider2, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(300.0f), FAUSTFLOAT(1.0f));
		ui_interface->declare(&fHslider1, "02", "");
		ui_interface->declare(&fHslider1, "symbol", "input");
		ui_interface->declare(&fHslider1, "unit", "%");
		ui_interface->addHorizontalSlider("Input amount", &fHslider1, FAUSTFLOAT(100.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(100.0f), FAUSTFLOAT(0.00999999978f));
		ui_interface->declare(&fHslider3, "03", "");
		ui_interface->declare(&fHslider3, "scale", "log");
		ui_interface->declare(&fHslider3, "symbol", "input_lowpass");
		ui_interface->declare(&fHslider3, "unit", "Hz");
		ui_interface->addHorizontalSlider("Input low-pass cutoff", &fHslider3, FAUSTFLOAT(10000.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(20000.0f), FAUSTFLOAT(1.0f));
		...
		ui_interface->addHorizontalSlider("Input high-pass cutoff", &fHslider4, FAUSTFLOAT(100.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(1000.0f), FAUSTFLOAT(1.0f));
		...
		ui_interface->addHorizontalSlider("Input diffusion 1", &fHslider5, FAUSTFLOAT(75.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(100.0f), FAUSTFLOAT(0.00999999978f));
		...
		ui_interface->addHorizontalSlider("Input diffusion 2", &fHslider6, FAUSTFLOAT(62.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(100.0f), FAUSTFLOAT(0.00999999978f));
		ui_interface->declare(&fHslider7, "07", "");
		ui_interface->declare(&fHslider7, "symbol", "tail_density");
		ui_interface->declare(&fHslider7, "unit", "%");
		ui_interface->addHorizontalSlider("Tail density", &fHslider7, FAUSTFLOAT(70.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(100.0f), FAUSTFLOAT(0.00999999978f));
		ui_interface->declare(&fHslider0, "08", "");
		ui_interface->declare(&fHslider0, "symbol", "decay");
		ui_interface->declare(&fHslider0, "unit", "%");
		ui_interface->addHorizontalSlider("Decay", &fHslider0, FAUSTFLOAT(50.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(100.0f), FAUSTFLOAT(0.00999999978f));
		...
		ui_interface->addHorizontalSlider("Damping", &fHslider10, FAUSTFLOAT(5500.0f), FAUSTFLOAT(10.0f), FAUSTFLOAT(20000.0f), FAUSTFLOAT(1.0f));
		...
		ui_interface->addHorizontalSlider("Modulator frequency", &fHslider9, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.00999999978f), FAUSTFLOAT(4.0f), FAUSTFLOAT(0.00999999978f));
		ui_interface->declare(&fHslider8, "11", "");
		ui_interface->declare(&fHslider8, "symbol", "mod_depth");
		ui_interface->declare(&fHslider8, "unit", "ms");
		ui_interface->addHorizontalSlider("Modulator depth", &fHslider8, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(10.0f), FAUSTFLOAT(0.100000001f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow3 = fConst2 * std::exp(fConst5 * (0.0f - 6.28318548f * float(fHslider3)));
		float fSlow4 = fConst2 * std::exp(fConst5 * (0.0f - 6.28318548f * float(fHslider4)));
		...
		float fSlow10 = fConst2 * std::exp(fConst5 * (0.0f - 6.28318548f * float(fHslider10)));
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			fRec8[0] = fSlow0 + fConst3 * fRec8[1];
			float fTemp0 = std::min<float>(0.5f, std::max<float>(0.25f, fRec8[0] + 0.150000006f));
			fRec22[0] = fSlow1 + fConst3 * fRec22[1];
			fVec0[IOTA0 & 131071] = float(input1[i0]) * fRec22[0];
			fRec23[0] = fSlow2 + fConst3 * fRec23[1];
			int iTemp1 = std::min<int>(65536, std::max<int>(0, int(fConst0 * fRec23[0])));
			fRec24[0] = fSlow3 + fConst3 * fRec24[1];
			fRec21[0] = fVec0[(IOTA0 - iTemp1) & 131071] + fRec24[0] * fRec21[1];
			...
			float fTemp5 = (0.5f * fRec20[0] * fTemp3 + fRec20[1] * fTemp4) - fRec26[0] * fRec18[1];
			fVec1[IOTA0 & 1023] = fTemp5;
			fRec18[0] = fVec1[(IOTA0 - iConst6) & 1023];
			float fRec19 = fRec26[0] * fTemp5;
			float fTemp6 = (fRec19 + fRec18[1]) - fRec26[0] * fRec16[1];
			fVec2[IOTA0 & 1023] = fTemp6;
			fRec16[0] = fVec2[(IOTA0 - iConst7) & 1023];
			...
			int iTemp11 = int(fConst0 * (fRec33[0] * ftbl0mydspSIG0[int(65536.0f * (fRec35[0] + 0.25f - float(int(fRec35[0] + 0.25f))))] + 0.0305097271f)) + -1;
			float fThen1 = (((fRec30[1] == 1.0f) & (iTemp11 != iRec32[1])) ? fConst12 : 0.0f);
			float fThen3 = (((fRec30[1] == 0.0f) & (iTemp11 != iRec31[1])) ? fConst11 : fThen1);
			float fElse3 = (((fRec30[1] > 0.0f) & (fRec30[1] < 1.0f)) ? fRec29[1] : 0.0f);
			float fTemp12 = ((fRec29[1] != 0.0f) ? fElse3 : fThen3);
			fRec29[0] = fTemp12;
			fRec30[0] = std::max<float>(0.0f, std::min<float>(1.0f, fRec30[1] + fTemp12));
			iRec31[0] = (((fRec30[1] >= 1.0f) & (iRec32[1] != iTemp11)) ? iTemp11 : iRec31[1]);
			iRec32[0] = (((fRec30[1] <= 0.0f) & (iRec31[1] != iTemp11)) ? iTemp11 : iRec32[1]);
			float fTemp13 = fVec5[(IOTA0 - std::min<int>(65536, std::max<int>(0, iRec31[0]))) & 131071];
			fRec10[0] = fTemp13 + fRec30[0] * (fVec5[(IOTA0 - std::min<int>(65536, std::max<int>(0, iRec32[0]))) & 131071] - fTemp13);
			float fRec11 = 0.0f - fRec28[0] * fTemp9;
			float fTemp14 = fRec11 + fRec10[1];
			fVec7[IOTA0 & 32767] = fTemp14;
			fRec37[0] = fSlow10 + fConst3 * fRec37[1];
			fRec9[0] = fVec7[(IOTA0 - iConst13) & 32767] + fRec37[0] * fRec9[1];
			...
			fRec1[IOTA0 & 16383] = fRec9[0] * fTemp15;
			fRec2[IOTA0 & 32767] = fTemp14;
			fVec9[IOTA0 & 131071] = float(input0[i0]) * fRec22[0];
			fRec52[0] = fVec9[(IOTA0 - iTemp1) & 131071] + fRec24[0] * fRec52[1];
			fRec51[0] = fTemp2 * fRec52[0] + fRec25[0] * fRec51[1];
			float fTemp17 = (0.5f * fRec51[0] * fTemp3 + fTemp4 * fRec51[1]) - fRec26[0] * fRec49[1];
			...
			float fTemp21 = fRec43[1] + fRec8[0] * fRec0[(IOTA0 - iConst19) & 32767] + fRec44 + fRec28[0] * fRec41[1];
			fVec14[IOTA0 & 131071] = fTemp21;
			int iTemp22 = int(fConst0 * (fRec33[0] * ftbl0mydspSIG0[int(65536.0f * fRec35[0])] + 0.025603978f)) + -1;
			float fThen7 = (((fRec54[1] == 1.0f) & (iTemp22 != iRec56[1])) ? fConst12 : 0.0f);
			float fThen9 = (((fRec54[1] == 0.0f) & (iTemp22 != iRec55[1])) ? fConst11 : fThen7);
			float fElse9 = (((fRec54[1] > 0.0f) & (fRec54[1] < 1.0f)) ? fRec53[1] : 0.0f);
			float fTemp23 = ((fRec53[1] != 0.0f) ? fElse9 : fThen9);
			fRec53[0] = fTemp23;
			fRec54[0] = std::max<float>(0.0f, std::min<float>(1.0f, fRec54[1] + fTemp23));
			iRec55[0] = (((fRec54[1] >= 1.0f) & (iRec56[1] != iTemp22)) ? iTemp22 : iRec55[1]);
			iRec56[0] = (((fRec54[1] <= 0.0f) & (iRec55[1] != iTemp22)) ? iTemp22 : iRec56[1]);
			float fTemp24 = fVec14[(IOTA0 - std::min<int>(65536, std::max<int>(0, iRec55[0]))) & 131071];
			fRec41[0] = fTemp24 + fRec54[0] * (fVec14[(IOTA0 - std::min<int>(65536, std::max<int>(0, iRec56[0]))) & 131071] - fTemp24);
			float fRec42 = 0.0f - fRec28[0] * fTemp21;
			float fTemp25 = fRec42 + fRec41[1];
			fVec15[IOTA0 & 32767] = fTemp25;
			fRec40[0] = fVec15[(IOTA0 - iConst20) & 32767] + fRec37[0] * fRec40[1];
			...
			fRec4[IOTA0 & 8191] = fTemp15 * fRec40[0];
			fRec5[IOTA0 & 32767] = fTemp25;
			output0[i0] = FAUSTFLOAT(0.600000024f * ((fRec2[(IOTA0 - iConst22) & 32767] + fRec2[(IOTA0 - iConst23) & 32767] + fRec0[(IOTA0 - iConst24) & 32767]) - (fRec1[(IOTA0 - iConst25) & 16383] + fRec5[(IOTA0 - iConst26) & 32767] + fRec4[(IOTA0 - iConst27) & 8191] + fRec3[(IOTA0 - iConst28) & 32767])));
			output1[i0] = FAUSTFLOAT(0.600000024f * ((fRec5[(IOTA0 - iConst29) & 32767] + fRec5[(IOTA0 - iConst30) & 32767] + fRec3[(IOTA0 - iConst31) & 32767]) - (fRec4[(IOTA0 - iConst32) & 8191] + fRec2[(IOTA0 - iConst33) & 32767] + fRec1[(IOTA0 - iConst34) & 16383] + fRec0[(IOTA0 - iConst35) & 32767])));
			fRec8[1] = fRec8[0];
			fRec22[1] = fRec22[0];
			IOTA0 = IOTA0 + 1;
			fRec23[1] = fRec23[0];
